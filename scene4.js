class scene4 extends Phaser.Scene {
    ...
    create() {
        ...
        this.bg1 = this.add.tileSprite(0, 0, 3960, 940, 'bg_4') // Use tileSprite for seamless looping
            .setOrigin(0, 0)
            .setScrollFactor(0.1, 0);

        this.bgMain = this.add.tileSprite(0, 0, 3960, 940, 'bg_3') // Use tileSprite for seamless looping
            .setOrigin(0, 0)
